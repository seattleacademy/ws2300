...
# -------
#
#   Copyright (c) 2007,2008,2010,2011,2012,2013,2014 Russell Stuart.
#
...
def process_measurements(me, ws2300, args):
  ...
  all_measures = read_requests + [measure for measure, data in write_requests]
  if [isinstance(measure, HistoryMeasure) for measure in all_measures]:
